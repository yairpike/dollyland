    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <Tabs defaultValue="account" className="w-full">
          <TabsList className="flex w-fit overflow-x-auto bg-card border py-2 h-12 items-center gap-1 px-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
